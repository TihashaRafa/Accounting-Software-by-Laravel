...
<div class="row">
        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <tr class="odd">
                    <td class="dtr-control sorting_1" tabindex="0">{{ $items -> item_number }}</td>
                ...
                <td>
                    <a href="{{ route('service.edit', $items->id) }}" class="btn btn-info sm" title="Edit data"> <i class="fas fa-edit"></i> </a>
