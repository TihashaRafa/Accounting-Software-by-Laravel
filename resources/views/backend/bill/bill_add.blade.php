                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                    ...
                                    <form method="post" action="{{ route('bill.store') }}" id="myForm" enctype="multipart/form-data">
                                        ...
                                        @php
                                        $account = App\Models\Account::all();
                                        $catagory = App\Models\catagory::all();
                                        $payer = App\Models\Payer::all();
                                        @endphp


                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-from-label">Title</label>
                                            <input type="text" name="title" class="form-control select2-hidden-accessible" placeholder="INC-00073" value="" id="example-text-input">
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-from-label">Repeat Every</label>
                                            <input type="text" name="repeat" class="form-control select2-hidden-accessible" value="" id="example-text-input">
                                        </div>
