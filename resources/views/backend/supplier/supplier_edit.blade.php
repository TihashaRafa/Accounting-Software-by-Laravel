                                ...
                                <div class="card">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="cid" name="company" value="{{ $supplier->company }}" class="form-control select2-hidden-accessible" data-select2-id="cid" tabindex="-1" aria-hidden="true">
                                      ...
                                      <option value="2">USD</option>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <select class="form-control"  value="{{ $supplier->owner }}" name="owner" id="owner_id">
