                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="account" name="name" class="form-control" autofocus="">
                                            </div>
                                        </div> 
                                        <div class="mb-3 row">
                                            <label for="code" class="col-sm-3"><span class="h6">Code</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" id="code" name="code" class="form-control" value="CUS-00004">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="cid" name="company" class="form-control select2-hidden-accessible" data-select2-id="cid" tabindex="-1" aria-hidden="true">
                                             ...
                                             <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="business_number" name="business_num" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="business_number" name="mobile_no" class="form-control">
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="custom-control my-2 custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="defaultChecked" name="type" value="Customer" checked="">
                                                    <label class="custom-control-label" for="defaultChecked"><span class="h6">Customer</span></label>
                                                </div>

                                                <div class="custom-control my-2 custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="input_supplier" name="type" value="Supplier">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <select name="country" id="country" class="form-control select2-hidden-accessible" data-select2-id="country" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <button class="btn btn-primary mt-3 mr-3 waves-effect waves-themed" type="submit" id="submit">Save</button>
