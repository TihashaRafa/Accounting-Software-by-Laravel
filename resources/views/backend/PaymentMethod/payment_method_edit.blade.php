        ...
        <div class="widget-1 col-md-6 col-sm-12">
            <div class="panel">
                ...
                <div class="panel-container">
                    ...
                    <form method="post" action="{{ route('PaymentMethod.update') }}" id="myForm" enctype="multipart/form-data">
                                @csrf
                         ...
                         <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="payment_method_name" value="{{ $payment_method-> payment_method_name  }}">
                            </div>
